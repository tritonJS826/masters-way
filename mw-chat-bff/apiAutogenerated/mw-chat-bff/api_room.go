...
func (a *RoomAPIService) AddUserToRoomStreamExecute(r ApiAddUserToRoomRequest, request *http.Request) (*SchemasRoomPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *SchemasRoomPopulatedResponse
	)
...
// Execute executes the request
//  @return SchemasRoomPopulatedResponseStream
func (a *RoomAPIService) DeleteUserFromRoomStreamExecute(r ApiDeleteUserFromRoomRequest, request *http.Request) (*SchemasRoomPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarReturnValue  *SchemasRoomPopulatedResponse
	)
...
func (a *RoomAPIService) GetChatPreviewStreamExecute(r ApiGetChatPreviewRequest, request *http.Request) (*SchemasGetRoomPreviewResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarReturnValue  *SchemasGetRoomPreviewResponse
	)
