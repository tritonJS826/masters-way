...
func (r ApiGenerateMetricsRequest) Execute() ([]string, *http.Response, error) {
...
//  @return []string
func (a *GeminiAPIService) GenerateMetricsExecute(r ApiGenerateMetricsRequest) ([]string, *http.Response, error) {
	var (
