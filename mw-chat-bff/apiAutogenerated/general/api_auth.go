...
func (r ApiGetLinkedUserByTelegramIdRequest) Execute() (*InternalControllersGetLinkedUserResponse, *http.Response, error) {
	return r.ApiService.GetLinkedUserByTelegramIdExecute(r)
}

/*
GetLinkedUserByTelegramId Get linked user by telegram ID
...
// Execute executes the request
//  @return InternalControllersGetLinkedUserResponse
func (a *AuthAPIService) GetLinkedUserByTelegramIdExecute(r ApiGetLinkedUserByTelegramIdRequest) (*InternalControllersGetLinkedUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InternalControllersGetLinkedUserResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthAPIService.GetLinkedUserByTelegramId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/telegram/user/{telegramId}"
...
// Execute executes the request
//  @return InternalControllersGetLinkedUserResponseStream
func (a *AuthAPIService) GetLinkedUserByTelegramIdStreamExecute(r ApiGetLinkedUserByTelegramIdRequest, request *http.Request, GoogleAccessToken string) (*InternalControllersGetLinkedUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarReturnValue  *InternalControllersGetLinkedUserResponse
	)
