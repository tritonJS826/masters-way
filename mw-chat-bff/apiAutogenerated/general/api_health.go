...
func (r ApiHealthcheckGetRequest) Execute() (map[string]string, *http.Response, error) {
...
func (a *HealthAPIService) HealthcheckGetExecute(r ApiHealthcheckGetRequest) (map[string]string, *http.Response, error) {
	var (
