...
type ApiGetChatUsersByUuidsRequest struct {
	ctx context.Context
	ApiService *UserAPIService
	request *[]SchemasChatUserPayload
}

// query params
func (r ApiGetChatUsersByUuidsRequest) Request(request []SchemasChatUserPayload) ApiGetChatUsersByUuidsRequest {
	r.request = &request
	return r
}

func (r ApiGetChatUsersByUuidsRequest) Execute() ([]SchemasChatUserResponse, *http.Response, error) {
	return r.ApiService.GetChatUsersByUuidsExecute(r)
}

/*
GetChatUsersByUuids Get chat users by UUIDs

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetChatUsersByUuidsRequest
*/
func (a *UserAPIService) GetChatUsersByUuids(ctx context.Context) ApiGetChatUsersByUuidsRequest {
	return ApiGetChatUsersByUuidsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SchemasChatUserResponse
func (a *UserAPIService) GetChatUsersByUuidsExecute(r ApiGetChatUsersByUuidsRequest) ([]SchemasChatUserResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SchemasChatUserResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.GetChatUsersByUuids")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/users/chat"
