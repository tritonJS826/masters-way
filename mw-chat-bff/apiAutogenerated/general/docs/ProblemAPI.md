...
> MwServerInternalSchemasProblemPopulatedResponse CreateProblemTelegram(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwServerInternalSchemasCreateProblemForTelegramPayload("Description_example", false, "OwnerUuid_example", "WayUuid_example") // MwServerInternalSchemasCreateProblemForTelegramPayload | query params
	...
	// response from `CreateProblemTelegram`: MwServerInternalSchemasProblemPopulatedResponse
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**MwServerInternalSchemasCreateProblemForTelegramPayload**](MwServerInternalSchemasCreateProblemForTelegramPayload.md) | query params | 
