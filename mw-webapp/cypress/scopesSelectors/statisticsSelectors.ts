    ...
    statistics: {
        ...
        periodBlocks: {
            ...
            overallInfo: {
                ...
                getTotalTime: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.totalTime(period))),
                getTotalReports: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.totalReports(period))),
                getFinishedJobs: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.finishedJobs(period))),
                getAvgTimePerCalendarDay: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.avgTimePerCalendarDay(period))),
                getAverageTimePerWorkingDay: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.avgTimePerWorkingDay(period))),
                getAvgJobTime: (period: ModalPeriodBlockTitles | WayPagePeriodBlockTitles) => cy.get(getDataCy(statisticsAccessIds.statistics.periodBlocks.overallInfo.avgJobTime(period))),
            },
