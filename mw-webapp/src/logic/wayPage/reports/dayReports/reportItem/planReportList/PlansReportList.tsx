...
import {CopyPlanToJobDoneModalContent} from
  "src/logic/wayPage/reports/dayReports/reportItem/planReportList/copyPlanToJobDoneModalContent/CopyPlanToJobDoneModalContent";
