...
import styles from "src/logic/staticPages/privacyPolicyPage/PrivacyPolicyPage.module.scss";
  ...
  return (
    <VerticalContainer className={styles.container}>
      <Title
        ...
        text="Privacy Policy for &quot;Masters way&quot;"
        placeholder=""
      />
      <Separator />
      <Title
      ...
      <ul className={styles.list}>
        ...
        <li>
          ...
          in this Agreement) refers to &quot;Masters way&quot;.
        </li>
        <li>
          <b>
            Cookies
        ...
        <li>
          ...
          {" refers to \"Masters way\", accessible from "}
          <Link
            path="https://mastersway.netlify.app"
            className={styles.link}
          >
            https://mastersway.netlify.app
          </Link>
        </li>
        <li>
          <b>
      ...
      <div>
        ...
        Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You
        close Your web browser. Learn more about cookies on the Free Privacy Policy website article.
      </div>
      <div>
      ...
      />
      <div>
        TYour information, including Personal Data, is processed at the Company&apos;s operating offices and in any other
      ...
      <ul className={styles.list}>
        <li>
          By email: victorveretennikov58@gmail.com
        </li>
      </ul>
      <div>
