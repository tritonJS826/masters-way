...
import styles from "src/logic/staticPages/landingPages/footerLanding/FooterLanding.module.scss";
...
/**
 * FooterLanding component
 */
export const FooterLanding = (props: FooterLandingProps) => {
          ...
          <HorizontalContainer className={styles.socialBlock}>
            ...
            <VerticalContainer className={styles.socialMedia}>
              ...
              <HorizontalContainer className={styles.socialMediaIcons}>
                ...
                <Link
                  path="https://t.me/mastersway_bot"
                  isNewTab
                  ariaLabel={LanguageService.common.socialMediaAriaLabel.telegramBot[props.language]}
                >
                  <div className={styles.iconWrapper}>
                    <Icon
                      size={IconSize.SMALL}
