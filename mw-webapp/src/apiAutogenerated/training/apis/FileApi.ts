...
export class FileApi extends runtime.BaseAPI {
    ...
    async uploadFileRaw(requestParameters: UploadFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemasUploadFileResponse>> {
        if (requestParameters.multipart === null || requestParameters.multipart === undefined) {
            throw new runtime.RequiredError('multipart','Required parameter requestParameters.multipart was null or undefined when calling uploadFile.');
        }
        ...
        if (requestParameters.multipart !== undefined) {
            formParams.append('multipart', requestParameters.multipart as any);
        }
