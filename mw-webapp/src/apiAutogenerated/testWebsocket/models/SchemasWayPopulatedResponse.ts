...
import type { SchemasMetricTreeNode } from './SchemasMetricTreeNode';
import {
    SchemasMetricTreeNodeFromJSON,
    SchemasMetricTreeNodeFromJSONTyped,
    SchemasMetricTreeNodeToJSON,
} from './SchemasMetricTreeNode';
...
export interface SchemasWayPopulatedResponse {
     ...
     * @memberof SchemasWayPopulatedResponse
     */
    metrics: Array<SchemasMetricTreeNode>;
    /**
     * 
     * @type {string}
     * @memberof SchemasWayPopulatedResponse
...
export function SchemasWayPopulatedResponseFromJSONTyped(
    ...
    return {
        ...
        'metrics': ((json['metrics'] as Array<any>).map(SchemasMetricTreeNodeFromJSON)),
        'name': json['name'],
...
export function SchemasWayPopulatedResponseToJSON(value?: SchemasWayPopulatedResponse | null): any {
    ...
    return {
        ...
        'metrics': ((value.metrics as Array<any>).map(SchemasMetricTreeNodeToJSON)),
        'name': value.name,
