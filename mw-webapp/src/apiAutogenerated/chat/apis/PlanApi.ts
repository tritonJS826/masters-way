...
import {
    ...
    SchemasCreatePlanForTelegramPayloadFromJSON,
    SchemasCreatePlanForTelegramPayloadToJSON,
...
export interface CreatePlanTelegramRequest {
    request: SchemasCreatePlanForTelegramPayload;
}
...
export class PlanApi extends runtime.BaseAPI {
     ...
     */
    async createPlanTelegramRaw(requestParameters: CreatePlanTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemasPlanPopulatedResponse>> {
        if (requestParameters.request === null || requestParameters.request === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SchemasCreatePlanForTelegramPayloadToJSON(requestParameters.request),
        }, initOverrides);
     ...
     * Create plan for telegram
     */
    async createPlanTelegram(requestParameters: CreatePlanTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SchemasPlanPopulatedResponse> {
