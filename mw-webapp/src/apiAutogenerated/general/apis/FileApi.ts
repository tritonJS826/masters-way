...
import {
    MwGeneralBffInternalSchemasUploadFileResponseFromJSON,
    MwGeneralBffInternalSchemasUploadFileResponseToJSON,
} from '../models/index';
...
export class FileApi extends runtime.BaseAPI {
     ...
     */
    async uploadFileRaw(requestParameters: UploadFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasUploadFileResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MwGeneralBffInternalSchemasUploadFileResponseFromJSON(jsonValue));
    }
     ...
     * Upload file to storage
     */
    async uploadFile(requestParameters: UploadFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffInternalSchemasUploadFileResponse> {
