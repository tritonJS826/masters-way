...
import {
    MwGeneralBffInternalSchemasCreateJobDoneJobTagPayloadFromJSON,
    MwGeneralBffInternalSchemasCreateJobDoneJobTagPayloadToJSON,
} from '../models/index';

export interface CreateJobDoneJobTagRequest {
    request: MwGeneralBffInternalSchemasCreateJobDoneJobTagPayload;
}
...
export class JobDoneJobTagApi extends runtime.BaseAPI {
    ...
    async createJobDoneJobTagRaw(requestParameters: CreateJobDoneJobTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateJobDoneJobTagPayloadToJSON(requestParameters.request),
        }, initOverrides);
