...
import {
    ...
    MwGeneralBffInternalSchemasUpdateCommentPayloadToJSON,
} from '../models/index';
...
export class CommentApi extends runtime.BaseAPI {
     ...
     */
    async createCommentRaw(requestParameters: CreateCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasCommentPopulatedResponse>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateCommentPayloadToJSON(requestParameters.request),
        }, initOverrides);
     ...
     */
    async updateCommentRaw(requestParameters: UpdateCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasCommentPopulatedResponse>> {
        if (requestParameters.commentId === null || requestParameters.commentId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MwGeneralBffInternalSchemasUpdateCommentPayloadToJSON(requestParameters.request),
        }, initOverrides);
     ...
     * Update comment by UUID
     */
    async updateComment(requestParameters: UpdateCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffInternalSchemasCommentPopulatedResponse> {
