...
import {
    MwserverInternalSchemasCreateFavoriteUserWayPayloadFromJSON,
    MwserverInternalSchemasCreateFavoriteUserWayPayloadToJSON,
} from '../models/index';
...
export class FavoriteUserWayApi extends runtime.BaseAPI {
    ...
    async createFavoriteUserWayRaw(requestParameters: CreateFavoriteUserWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: MwserverInternalSchemasCreateFavoriteUserWayPayloadToJSON(requestParameters.request),
        }, initOverrides);
