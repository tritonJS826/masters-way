...
import {
    MwGeneralBffInternalSchemasAddWayToCompositeWayPayloadFromJSON,
    MwGeneralBffInternalSchemasAddWayToCompositeWayPayloadToJSON,
    MwGeneralBffInternalSchemasCompositeWayRelationFromJSON,
    MwGeneralBffInternalSchemasCompositeWayRelationToJSON,
} from '../models/index';
...
export class CompositeWayApi extends runtime.BaseAPI {
     ...
     */
    async createCompositeWayRaw(requestParameters: CreateCompositeWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasCompositeWayRelation>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasAddWayToCompositeWayPayloadToJSON(requestParameters.request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MwGeneralBffInternalSchemasCompositeWayRelationFromJSON(jsonValue));
    }

    /**
     * Add a way to composite way
     */
    async createCompositeWay(requestParameters: CreateCompositeWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffInternalSchemasCompositeWayRelation> {
