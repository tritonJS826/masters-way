...
import {
    MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponseFromJSON,
    MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponseToJSON,
    MwGeneralBffInternalSchemasCreateWayCollectionWayFromJSON,
    MwGeneralBffInternalSchemasCreateWayCollectionWayToJSON,
} from '../models/index';
...
export class WayCollectionWayApi extends runtime.BaseAPI {
     ...
     */
    async createWayCollectionWayRaw(requestParameters: CreateWayCollectionWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateWayCollectionWayToJSON(requestParameters.request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponseFromJSON(jsonValue));
    }

    /**
     * Create a new wayCollectionWay
     */
    async createWayCollectionWay(requestParameters: CreateWayCollectionWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse> {
