...
import {
    MwGeneralBffInternalSchemasCreateWayTagPayloadFromJSON,
    MwGeneralBffInternalSchemasCreateWayTagPayloadToJSON,
...
export class WayTagApi extends runtime.BaseAPI {
     ...
     * Create a new wayTag
     */
    async createWayTagRaw(requestParameters: CreateWayTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasWayTagResponse>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateWayTagPayloadToJSON(requestParameters.request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MwGeneralBffInternalSchemasWayTagResponseFromJSON(jsonValue));
    }

    /**
     * Create a new wayTag
     */
    async createWayTag(requestParameters: CreateWayTagRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffInternalSchemasWayTagResponse> {
