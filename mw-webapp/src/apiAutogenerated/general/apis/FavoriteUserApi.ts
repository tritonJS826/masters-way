...
import {
    MwGeneralBffInternalSchemasCreateFavoriteUserPayloadFromJSON,
    MwGeneralBffInternalSchemasCreateFavoriteUserPayloadToJSON,
} from '../models/index';

export interface CreateFavoriteUserRequest {
    request: MwGeneralBffInternalSchemasCreateFavoriteUserPayload;
}
...
export class FavoriteUserApi extends runtime.BaseAPI {
    ...
    async createFavoriteUserRaw(requestParameters: CreateFavoriteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateFavoriteUserPayloadToJSON(requestParameters.request),
        }, initOverrides);
