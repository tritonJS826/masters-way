...
import {
    ...
    InternalControllersTelegramLoginResponseToJSON,
    InternalControllersTelegramValidateRequestFromJSON,
    InternalControllersTelegramValidateRequestToJSON,
    InternalControllersTelegramValidateResponseFromJSON,
    InternalControllersTelegramValidateResponseToJSON,
    ...
    MwGeneralBffInternalSchemasCurrentUserResponseFromJSON,
    MwGeneralBffInternalSchemasCurrentUserResponseToJSON,
...
export interface TelegramInitiateRequest {
...
export class AuthApi extends runtime.BaseAPI {
     ...
     */
    async getCurrentAuthorizedUserRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MwGeneralBffInternalSchemasCurrentUserResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MwGeneralBffInternalSchemasCurrentUserResponseFromJSON(jsonValue));
    }

    /**
     * Get current authorized user
     */
    async getCurrentAuthorizedUser(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MwGeneralBffInternalSchemasCurrentUserResponse> {
     ...
     */
    async telegramInitiateRaw(requestParameters: TelegramInitiateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InternalControllersTelegramLoginResponse>> {
        if (requestParameters.request === null || requestParameters.request === undefined) {
            throw new runtime.RequiredError('request','Required parameter requestParameters.request was null or undefined when calling telegramInitiate.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: InternalControllersTelegramLoginRequestToJSON(requestParameters.request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => InternalControllersTelegramLoginResponseFromJSON(jsonValue));
    }
     ...
     * Initiate Telegram login
     */
    async telegramInitiate(requestParameters: TelegramInitiateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InternalControllersTelegramLoginResponse> {
        const response = await this.telegramInitiateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async telegramValidateRaw(requestParameters: TelegramValidateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InternalControllersTelegramValidateResponse>> {
        if (requestParameters.request === null || requestParameters.request === undefined) {
            throw new runtime.RequiredError('request','Required parameter requestParameters.request was null or undefined when calling telegramValidate.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: InternalControllersTelegramValidateRequestToJSON(requestParameters.request),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => InternalControllersTelegramValidateResponseFromJSON(jsonValue));
    }
