...
import {
    MwGeneralBffInternalSchemasCreateMentorUserWayPayloadFromJSON,
    MwGeneralBffInternalSchemasCreateMentorUserWayPayloadToJSON,
    MwGeneralBffInternalSchemasDeleteMentorUserWayPayloadFromJSON,
    MwGeneralBffInternalSchemasDeleteMentorUserWayPayloadToJSON,
} from '../models/index';
...
export class MentorUserWayApi extends runtime.BaseAPI {
    ...
    async createMentorUserWayRaw(requestParameters: CreateMentorUserWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: MwGeneralBffInternalSchemasCreateMentorUserWayPayloadToJSON(requestParameters.request),
        }, initOverrides);
    ...
    async deleteMentorUserWayRaw(requestParameters: DeleteMentorUserWayRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MwGeneralBffInternalSchemasDeleteMentorUserWayPayloadToJSON(requestParameters.request),
        }, initOverrides);
