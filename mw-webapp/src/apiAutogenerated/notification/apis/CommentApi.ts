...
import {
    ...
    SchemasCreateCommentForTelegramPayloadFromJSON,
    SchemasCreateCommentForTelegramPayloadToJSON,
...
export interface CreateCommentTelegramRequest {
    request: SchemasCreateCommentForTelegramPayload;
}
...
export class CommentApi extends runtime.BaseAPI {
     ...
     */
    async createCommentTelegramRaw(requestParameters: CreateCommentTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemasCommentPopulatedResponse>> {
        if (requestParameters.request === null || requestParameters.request === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SchemasCreateCommentForTelegramPayloadToJSON(requestParameters.request),
        }, initOverrides);
     ...
     * Create comment for telegram
     */
    async createCommentTelegram(requestParameters: CreateCommentTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SchemasCommentPopulatedResponse> {
