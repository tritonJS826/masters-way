...
import {
    ...
    SchemasCreateJobDoneForTelegramPayloadFromJSON,
    SchemasCreateJobDoneForTelegramPayloadToJSON,
...
export interface CreateJobDoneTelegramRequest {
    request: SchemasCreateJobDoneForTelegramPayload;
}
...
export class JobDoneApi extends runtime.BaseAPI {
     ...
     */
    async createJobDoneTelegramRaw(requestParameters: CreateJobDoneTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemasJobDonePopulatedResponse>> {
        if (requestParameters.request === null || requestParameters.request === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SchemasCreateJobDoneForTelegramPayloadToJSON(requestParameters.request),
        }, initOverrides);
     ...
     * Create job done for telegram
     */
    async createJobDoneTelegram(requestParameters: CreateJobDoneTelegramRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SchemasJobDonePopulatedResponse> {
