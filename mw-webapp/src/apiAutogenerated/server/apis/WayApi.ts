...
import {
    ...
    SchemasUserOwnWayFromJSON,
    SchemasUserOwnWayToJSON,
    SchemasWayPlainForNotificationResponseFromJSON,
    SchemasWayPlainForNotificationResponseToJSON,
...
export class WayApi extends runtime.BaseAPI {
     ...
     * Get user\'s own ways
     */
    async getUserOwnWaysRaw(requestParameters: GetUserOwnWaysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SchemasUserOwnWay>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(SchemasUserOwnWayFromJSON));
    }
     ...
     * Get user\'s own ways
     */
    async getUserOwnWays(requestParameters: GetUserOwnWaysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SchemasUserOwnWay>> {
     ...
     */
    async getWayPlainForNotificationByUuidRaw(requestParameters: GetWayPlainForNotificationByUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchemasWayPlainForNotificationResponse>> {
        if (requestParameters.wayId === null || requestParameters.wayId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SchemasWayPlainForNotificationResponseFromJSON(jsonValue));
    }

    /**
     * Get way plain for notification by UUID
     */
    async getWayPlainForNotificationByUuid(requestParameters: GetWayPlainForNotificationByUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SchemasWayPlainForNotificationResponse> {
