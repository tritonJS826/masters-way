...
import {
    ...
    SchemasShortUserFromJSON,
    SchemasShortUserToJSON,
...
export class UserApi extends runtime.BaseAPI {
     ...
     * Get users by ids
     */
    async getUsersByIdsRaw(requestParameters: GetUsersByIdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SchemasShortUser>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(SchemasShortUserFromJSON));
    }

    /**
     * Get users by ids
     */
    async getUsersByIds(requestParameters: GetUsersByIdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SchemasShortUser>> {
