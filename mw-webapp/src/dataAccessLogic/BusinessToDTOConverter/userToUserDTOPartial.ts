import {MwserverInternalSchemasUpdateUserPayload} from "src/apiAutogenerated/general";
 ...
 */
export const userToUserDTOPartial = (user: PartialWithUuid<User>): MwserverInternalSchemasUpdateUserPayload => {
  const userPartialDTO: MwserverInternalSchemasUpdateUserPayload = {
    name: user.name,
