import {MwGeneralBffInternalSchemasCompositeWayRelation} from "src/apiAutogenerated/general";
...
export class CompositeWayDAL {
   ...
   */
  public static async addWayToComposite(params: CompositeWayParams): Promise<MwGeneralBffInternalSchemasCompositeWayRelation> {
