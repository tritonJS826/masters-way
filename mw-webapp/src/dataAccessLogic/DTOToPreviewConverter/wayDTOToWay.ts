import {MwServerInternalSchemasMetricTreeNode, MwServerInternalSchemasWayPopulatedResponse} from "src/apiAutogenerated/general";
 ...
 * Map tree metrics
 */
export const mapTreeMetrics = (metricA: MwServerInternalSchemasMetricTreeNode): Metric => {
 ...
 */
export const wayDTOToWay = (wayDTO: MwServerInternalSchemasWayPopulatedResponse, dayReports: DayReportsParams): Way => {
