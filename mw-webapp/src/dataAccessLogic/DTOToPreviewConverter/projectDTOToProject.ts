import {MwGeneralBffInternalSchemasProjectPopulatedResponse} from "src/apiAutogenerated/general";
 ...
 */
export const projectDTOToProject = (projectDTO: MwGeneralBffInternalSchemasProjectPopulatedResponse): Project => {
  return new Project({
    ...projectDTO,
    uuid: projectDTO.id,
