import {MwServerInternalSchemasWayStatistics} from "src/apiAutogenerated/general";
 ...
 */
export const wayStatisticsDTOToWayStatistics = (wayStatisticsDTO: MwServerInternalSchemasWayStatistics): WayStatistics => {
