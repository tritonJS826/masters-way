...
import {trainingTopicDTOToTrainingTopic} from "src/dataAccessLogic/DTOToPreviewConverter/trainingTopicDTOToTrainingTopic";
...
export const trainingDTOToTraining = (
  ...
  return new Training({
    ...trainingDTO,
    trainingTags: trainingDTO.trainingTag,
    ...
    topics: trainingDTO.topics.map(trainingTopicDTOToTrainingTopic),
  });
};
