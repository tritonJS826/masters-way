import {MwServerInternalSchemasCompositeDayReportPopulatedResponse} from "src/apiAutogenerated/general";
 ...
 */
export const dayReportDTOToDayReport = (dayReportDTO: MwServerInternalSchemasCompositeDayReportPopulatedResponse): DayReport => {
