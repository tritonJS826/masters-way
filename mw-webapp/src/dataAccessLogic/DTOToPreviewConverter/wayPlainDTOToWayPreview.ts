import {MwserverInternalSchemasWayPlainResponse} from "src/apiAutogenerated/general";
 ...
 */
export const wayPlainDTOToWayPreview = (wayDTO: MwserverInternalSchemasWayPlainResponse): WayPreview => {
