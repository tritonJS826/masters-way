import {MwGeneralBffInternalSchemasWayPlainResponse} from "src/apiAutogenerated/general";
 ...
 */
export const wayPlainDTOToWayPreview = (wayDTO: MwGeneralBffInternalSchemasWayPlainResponse): WayPreview => {
