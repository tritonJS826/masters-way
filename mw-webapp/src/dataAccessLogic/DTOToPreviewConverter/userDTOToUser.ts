import {MwGeneralBffInternalSchemasUserPopulatedResponse} from "src/apiAutogenerated/general";
 ...
 */
export const userDTOToUserConverter = (userDTO: MwGeneralBffInternalSchemasUserPopulatedResponse): User => {
  return new User({
    ...userDTO,
    ...
    skills: userDTO.tags,
    contacts: userDTO.userContacts.map(contactDTOToContact),
  });
};
