import {MwGeneralBffInternalSchemasWayCollectionPopulatedResponse} from "src/apiAutogenerated/general";
...
export class WayCollectionDAL {
  ...
  public static async createWayCollection(params: createWayCollectionParams): Promise<WayCollection> {
    const wayCollectionDTO: MwGeneralBffInternalSchemasWayCollectionPopulatedResponse =
      await WayCollectionService.createWayCollection({
        request: {
