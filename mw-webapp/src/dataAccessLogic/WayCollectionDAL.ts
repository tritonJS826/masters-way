import {MwserverInternalSchemasWayCollectionPlainResponse} from "src/apiAutogenerated/general";
...
export class WayCollectionDAL {
  ...
  public static async createWayCollection(params: createWayCollectionParams): Promise<WayCollection> {
    const wayCollectionDTO: MwserverInternalSchemasWayCollectionPlainResponse = await WayCollectionService.createWayCollection({
      request: {
