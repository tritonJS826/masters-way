 ...
 */
import {MwChatBffInternalSchemasGetRoomPreviewResponse} from "src/apiAutogenerated/chat";
...
/**
 * Event fired when reconnecting to mw-chat-websocket.
 */
export type ChatMetaInfoPayload = MwChatBffInternalSchemasGetRoomPreviewResponse;

/**
 * Factory for {@link ChatConnectionEstablishedPayload} event
 * Used for creating new event objects
 */
export const makeChatMetaInfoReceivedEvent = (payload: ChatMetaInfoPayload) => {
  return populateWithBaseEvent(
    payload,
    ChannelId.CHAT,
    ChatEventId.META_INFO_RECEIVED,
    currentWindowEventConfig,
  );
};
