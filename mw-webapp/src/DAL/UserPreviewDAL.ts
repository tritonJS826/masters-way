...
// import {WayCollectionService} from "src/serviceUpdated/WayCollectionService";
...
export class UserPreviewDAL {
  ...
  //     const wayCollections = await WayCollectionService.getWayCollections({userId: userDTO.uuid});
  //     const ownWaysCollection = wayCollections.find((wayCollection) => wayCollection.name === "ownWays");
  //     const mentoringWaysCollection = wayCollections.find((wayCollection) => wayCollection.name === "mentoringWays");
  //     const favoriteWaysCollection = wayCollections.find((wayCollection) => wayCollection.name === "favoriteWays");
  ...
  //     return UserDTOToUserNotSaturatedWayConverter(userDTO, userProps);
  //   });

  //   const wayCollections = await WayCollectionService.getWayCollections();
