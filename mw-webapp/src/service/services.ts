...
import {Configuration as NotificationConfiguration, NotificationApi} from "src/apiAutogenerated/notification";
...
export const notification = new NotificationApi(notificationConfiguration);
