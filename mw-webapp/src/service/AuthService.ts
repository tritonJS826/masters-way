...
export class AuthService {
   ...
   */
  public static async getCurrentUser(): Promise<MwGeneralBffInternalSchemasUserPopulatedResponse> {
  ...
  public static async refreshToken(
    refreshToken: string,
  ): Promise<MwGeneralBffInternalSchemasRefreshAccessTokenResponse> {
