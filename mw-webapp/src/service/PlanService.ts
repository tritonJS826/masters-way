...
export class PlanService {
   ...
   * Create plan
   */
  public static async createPlan(requestParameters: CreatePlanRequest):
   Promise<MwGeneralBffInternalSchemasPlanPopulatedResponse> {
   ...
   * Update plan
   */
  public static async updatePlan(requestParameters: UpdatePlanRequest):
   Promise<MwGeneralBffInternalSchemasPlanPopulatedResponse> {
