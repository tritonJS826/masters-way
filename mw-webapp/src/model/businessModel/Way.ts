...
export class Way {
   ...
   * @value @UserPreview
   */
  // public mentors: Map<string, UserNotSaturatedWay>;
  public mentors: Map<string, SchemasUserPlainResponse>;
   ...
   * @value @UserPreview
   */
  // public formerMentors: Map<string, UserNotSaturatedWay>;
  public formerMentors: Map<string, SchemasUserPlainResponse>;

  /**
   * Users who sent request to become Way's mentor
   */
  public mentorRequests: SchemasUserPlainResponse[];
