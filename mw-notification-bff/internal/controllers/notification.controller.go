...
func (nc *NotificationController) GetNotificationList(ctx *gin.Context) {
	response, err := nc.notificationService.GetNotificationList(ctx)
	utils.HandleErrorGin(ctx, err)

	ctx.JSON(http.StatusOK, response)
}

type NotificationResponse openapiNotification.SchemasNotificationResponse
...
func (nc *NotificationController) UpdateNotification(ctx *gin.Context) {
	...
	notification, err := nc.notificationService.UpdateNotification(ctx, notificationID, payload.IsRead)
	utils.HandleErrorGin(ctx, err)

	ctx.JSON(http.StatusOK, notification)
}

type GetEnabledNotificationListResponse openapiNotification.SchemasGetEnabledNotificationListResponse
...
func (nc *NotificationController) GetEnabledNotificationList(ctx *gin.Context) {
	response, err := nc.notificationService.GetEnabledNotificationList(ctx)
	utils.HandleErrorGin(ctx, err)

	ctx.JSON(http.StatusOK, response)
}

type EnabledNotificationResponse openapiNotification.SchemasEnabledNotificationResponse
