...
services=("mw-webapp" "mw-survey" "mw-storage" "mw-mail" "mw-notification" "mw-notification-bff" "mw-notification-websocket" "mw-server" "mw-chat-websocket" "mw-chat-bff" "mw-chat" "grafana")
