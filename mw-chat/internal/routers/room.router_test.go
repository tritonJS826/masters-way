...
import (
	"context"
	openapiChat "mw-chat/apiAutogenerated/chat"
			...
			Messages: []openapiChat.MwChatInternalSchemasMessageResponse{
				{
					...
					MessageReaders: []openapiChat.MwChatInternalSchemasMessageReader{},
				},
				{
...
func TestGetChatPreview(t *testing.T) {
	...
	t.Run("should return chat preview with correct unread messages amount", func(t *testing.T) {
		...
		expectedData := openapiChat.MwChatInternalSchemasGetChatPreviewResponse{
...
func TestGetRooms(t *testing.T) {
	...
	t.Run("should return list of private rooms successfully", func(t *testing.T) {
		...
		nullableName := openapiChat.NullableString{}
		nullableName.Set(nil)
		expectedData := &openapiChat.MwChatInternalSchemasGetRoomsResponse{
			Size: 3,
...
func TestCreateRoom(t *testing.T) {
	...
	request := openapiChat.MwChatInternalSchemasCreateRoomPayload{
