...
func TestCreateMessage(t *testing.T) {
	...
	t.Run("should create a message in private room and return it successfully", func(t *testing.T) {
		...
		request := openapiChat.MwChatInternalSchemasCreateMessagePayload{
		...
		expectedData := &openapiChat.MwChatInternalSchemasCreateMessageResponse{
			Users: []string{currentUserID, userID},
			Message: openapiChat.MwChatInternalSchemasMessageResponse{
