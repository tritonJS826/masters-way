...
func NewMentorRequestController(db *dbPGX.Queries, ctx context.Context) *MentorRequestController {
...
func (cc *MentorRequestController) GetMentorRequestsByUserId(ctx *gin.Context) {
	...
	reqs, err := cc.dbPGX.GetMentorRequestByUserId(ctx, pgtype.UUID{
