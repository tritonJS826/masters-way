...
const populateDb = `-- name: PopulateDb :exec
DO $$
BEGIN
...
func (q *Queries) PopulateDb(ctx context.Context) error {
	_, err := q.exec(ctx, q.populateDbStmt, populateDb)
	return err
}
