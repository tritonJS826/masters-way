...
func (pms *PracticeMaterialService) CreatePracticeMaterial(ctx context.Context, params db.CreatePracticeMaterialInTopicParams) (*pb.PracticeMaterial, error) {
	...
	practiceMaterial := &pb.PracticeMaterial{
		Uuid:         *util.MarshalPgUUID(practiceMaterialDb.Uuid),
		TopicUuid:    *util.MarshalPgUUID(practiceMaterialDb.TopicUuid),
		...
		CreatedAt:    *util.MarshalPgTimestamp(practiceMaterialDb.CreatedAt),
		UpdatedAt:    *util.MarshalPgTimestamp(practiceMaterialDb.UpdatedAt),
	}
