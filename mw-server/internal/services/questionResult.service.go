...
func (ts *QuestionResultService) CreateQuestionResult(ctx context.Context, params db.CreateQuestionResultParams) (*pb.QuestionResult, error) {
	...
	return &pb.QuestionResult{
		Uuid:                *util.MarshalPgUUID(questionResultDb.Uuid),
		QuestionUuid:        *util.MarshalPgUUID(questionResultDb.QuestionUuid),
		UserUuid:            *util.MarshalPgUUID(questionResultDb.UserUuid),
