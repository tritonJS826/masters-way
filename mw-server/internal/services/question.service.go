...
func (ts *QuestionService) GetQuestionById(ctx context.Context, params GetQuestionByIdParams) (*pb.Question, error) {
	...
	return &pb.Question{
		Uuid:         *util.MarshalPgUUID(questionDb.Uuid),
		TestUuid:     *util.MarshalPgUUID(questionDb.TestUuid),
		...
		CreatedAt:    questionDb.CreatedAt.Time.Format(util.DEFAULT_STRING_LAYOUT),
		UpdatedAt:    questionDb.UpdatedAt.Time.Format(util.DEFAULT_STRING_LAYOUT),
	}, nil
}
