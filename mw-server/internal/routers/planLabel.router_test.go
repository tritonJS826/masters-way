...
func TestCreatePlanTag(t *testing.T) {
	...
	labelID := "c73ff20b-e64e-4e5f-b270-1a40ba1bd81b"
	...
	t.Run("should create plan job tag successfully", func(t *testing.T) {
		...
		requestCreateJobTag := openapiGeneral.SchemasCreatePlanLabelPayload{
			LabelUuid: labelID,
			PlanUuid:  plan.Uuid,
		}
		response, err := generalApi.PlanLabelAPI.CreatePlanLabel(ctx).Request(requestCreateJobTag).Execute()
		if err != nil {
...
func TestDeletePlanJobTagById(t *testing.T) {
	...
	labelID := "5ebb8d43-b685-4090-8453-ceaa7aad2095"
	...
	t.Run("should create plan job tag successfully", func(t *testing.T) {
		...
		response, err := generalApi.PlanLabelAPI.DeletePlanLabel(ctx, labelID, planID).Execute()
		if err != nil {
