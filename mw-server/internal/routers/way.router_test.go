		...
		expectedData := &openapiGeneral.MwServerInternalSchemasWayStatisticsTriplePeriod{
			TotalTime: openapiGeneral.MwServerInternalSchemasWayStatistics{
				TimeSpentByDayChart: []openapiGeneral.MwServerInternalSchemasTimeSpentByDayPoint{
					{Date: GetTimestampMinusDays(10), Value: 10},
					{Date: GetTimestampMinusDays(9), Value: 120},
					{Date: GetTimestampMinusDays(8), Value: 60},
					{Date: GetTimestampMinusDays(7), Value: 60},
					{Date: GetTimestampMinusDays(6), Value: 60},
					{Date: GetTimestampMinusDays(5), Value: 60},
					{Date: GetTimestampMinusDays(4), Value: 0},
					{Date: GetTimestampMinusDays(3), Value: 60},
					{Date: GetTimestampMinusDays(2), Value: 0},
				},
				OverallInformation: openapiGeneral.MwServerInternalSchemasOverallInformation{
					TotalTime:                 430,
					TotalReports:              8,
					FinishedJobs:              8,
					AverageTimePerCalendarDay: 48,
			...
			LastMonth: openapiGeneral.MwServerInternalSchemasWayStatistics{
				TimeSpentByDayChart: []openapiGeneral.MwServerInternalSchemasTimeSpentByDayPoint{
					{Date: GetTimestampMinusDays(32), Value: 0},
					{Date: GetTimestampMinusDays(31), Value: 0},
					{Date: GetTimestampMinusDays(30), Value: 0},
					{Date: GetTimestampMinusDays(29), Value: 0},
					{Date: GetTimestampMinusDays(28), Value: 0},
					{Date: GetTimestampMinusDays(27), Value: 0},
					{Date: GetTimestampMinusDays(26), Value: 0},
					{Date: GetTimestampMinusDays(25), Value: 0},
					{Date: GetTimestampMinusDays(24), Value: 0},
					{Date: GetTimestampMinusDays(23), Value: 0},
					{Date: GetTimestampMinusDays(22), Value: 0},
					{Date: GetTimestampMinusDays(21), Value: 0},
					{Date: GetTimestampMinusDays(20), Value: 0},
					{Date: GetTimestampMinusDays(19), Value: 0},
					{Date: GetTimestampMinusDays(18), Value: 0},
					{Date: GetTimestampMinusDays(17), Value: 0},
					{Date: GetTimestampMinusDays(16), Value: 0},
					{Date: GetTimestampMinusDays(15), Value: 0},
					{Date: GetTimestampMinusDays(14), Value: 0},
					{Date: GetTimestampMinusDays(13), Value: 0},
					{Date: GetTimestampMinusDays(12), Value: 0},
					{Date: GetTimestampMinusDays(11), Value: 0},
					{Date: GetTimestampMinusDays(10), Value: 10},
					{Date: GetTimestampMinusDays(9), Value: 120},
					{Date: GetTimestampMinusDays(8), Value: 60},
					{Date: GetTimestampMinusDays(7), Value: 60},
			...
			LastWeek: openapiGeneral.MwServerInternalSchemasWayStatistics{
				...
				OverallInformation: openapiGeneral.MwServerInternalSchemasOverallInformation{
					...
					TotalReports:              6,
					FinishedJobs:              5,
					AverageTimePerCalendarDay: 43,
					AverageTimePerWorkingDay:  50,
					AverageJobTime:            60,
				},
				LabelStatistics: openapiGeneral.MwServerInternalSchemasLabelStatistics{
					Labels: []openapiGeneral.MwServerInternalSchemasLabelInfo{
