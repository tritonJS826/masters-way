			...
			Ways: []openapiGeneral.SchemasWayPlainResponse{
				{
					...
					Id:        "a2cb5e1b-44df-48d3-b7a1-34f3d7a5b7e2",
				...
				},
				{
					...
					UpdatedAt: "2024-08-10T00:00:00.000Z",
					Id:        "aa13eee9-7dca-46ed-a3f7-21d8b7ae3b72",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-08-10T00:00:00.000Z",
					Id:        "9230479a-a481-4f83-b770-138ef4f3139c",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					Id:        "5cc724a0-383f-45ad-99a1-8514f51717f2",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-07-22T00:00:00.000Z",
					Id:        "78f86c77-2018-4511-90dc-d96df77f496a",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids: []string{
					...
					Id:        "9e77b89d-57c4-4b7f-8cd4-8dfc6bcb7d1b",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-07-09T00:00:00.000Z",
					Id:        "dce03ca6-f626-4c33-a44b-5a1b4ff62aa7",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-07-09T00:00:00.000Z",
					Id:        "9972552a-c0b3-41f3-b464-284d36a36964",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-07-09T00:00:00.000Z",
					Id:        "77a9e7c4-edb4-4b61-8065-cfd0c5c2506d",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
				{
					ChildrenUuids:    []string{},
					...
					UpdatedAt: "2024-07-09T00:00:00.000Z",
					Id:        "77482c3f-cae6-494d-be1d-d06c1e84450b",
					WayTags:   []openapiGeneral.SchemasWayTagResponse{},
				},
			},
		}
...
func TestGetWayById(t *testing.T) {
	...
	t.Run("should get all ways successfully", func(t *testing.T) {
		...
		assert.Equal(t, http.StatusOK, response.StatusCode)
		assert.Equal(t, expectedData.Id, way.Id)
