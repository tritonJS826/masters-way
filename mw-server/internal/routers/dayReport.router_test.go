...
func TestCreateDayReport(t *testing.T) {
	...
	t.Run("should get all ways successfully", func(t *testing.T) {
		...
		assert.Equal(t, expectedData.CompositionParticipants[0].WayName, report.CompositionParticipants[0].WayName)
		assert.Equal(t, expectedData.CompositionParticipants[0].WayId, report.CompositionParticipants[0].WayId)
	})
}
...
func TestGetDayReports(t *testing.T) {
	...
	t.Run("should get all ways successfully", func(t *testing.T) {
		...
		assert.Equal(t, expectedData.DayReports[0].Comments, report.DayReports[0].Comments)
		assert.Equal(t, expectedData.DayReports[0].CompositionParticipants, report.DayReports[0].CompositionParticipants)
		assert.Equal(t, expectedData.DayReports[0].JobsDone, report.DayReports[0].JobsDone)
		assert.Equal(t, expectedData.DayReports[0].Plans, report.DayReports[0].Plans)
		assert.Equal(t, expectedData.DayReports[0].Problems, report.DayReports[0].Problems)
	})
}
