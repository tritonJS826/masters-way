...
type SchemasTimeSpentByDayPoint struct {
	...
	TimeUnits int32 `json:"timeUnits"`
}
...
func NewSchemasTimeSpentByDayPoint(date string, timeUnits int32) *SchemasTimeSpentByDayPoint {
...
// GetTimeUnits returns the TimeUnits field value
func (o *SchemasTimeSpentByDayPoint) GetTimeUnits() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// GetTimeUnitsOk returns a tuple with the TimeUnits field value
// and a boolean to check if the value has been set.
func (o *SchemasTimeSpentByDayPoint) GetTimeUnitsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// SetTimeUnits sets field value
func (o *SchemasTimeSpentByDayPoint) SetTimeUnits(v int32) {
	o.TimeUnits = v
}
