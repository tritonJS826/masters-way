...
> MwServerInternalSchemasCompanionFeedback GetCompanionFeedback(ctx, wayId).Execute()
...
func main() {
	...
	// response from `GetCompanionFeedback`: MwServerInternalSchemasCompanionFeedback
...
[**MwServerInternalSchemasCompanionFeedback**](MwServerInternalSchemasCompanionFeedback.md)
