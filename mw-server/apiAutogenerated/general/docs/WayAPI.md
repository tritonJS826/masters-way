...
> SchemasWayStatistics GetWayStatisticsByUuid(ctx, wayId).Execute()
...
func main() {
	...
	// response from `GetWayStatisticsByUuid`: SchemasWayStatistics
...
[**SchemasWayStatistics**](SchemasWayStatistics.md)
