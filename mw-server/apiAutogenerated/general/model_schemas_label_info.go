...
func NewSchemasLabelInfo(jobsAmount int32, jobsAmountPercentage int32, labelID string, labelName string, time int32, timePercentage int32) *SchemasLabelInfo {
...
func (o *SchemasLabelInfo) GetLabelID() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SchemasLabelInfo) GetLabelIDOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SchemasLabelInfo) SetLabelID(v string) {
	o.LabelID = v
}

// GetLabelName returns the LabelName field value
func (o *SchemasLabelInfo) GetLabelName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SchemasLabelInfo) GetLabelNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SchemasLabelInfo) SetLabelName(v string) {
	o.LabelName = v
}
