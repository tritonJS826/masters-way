...
func (r ApiGetWayStatisticsByUuidRequest) Execute() (*SchemasWayStatistics, *http.Response, error) {
...
// Execute executes the request
//  @return SchemasWayStatistics
func (a *WayAPIService) GetWayStatisticsByUuidExecute(r ApiGetWayStatisticsByUuidRequest) (*SchemasWayStatistics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SchemasWayStatistics
	)
