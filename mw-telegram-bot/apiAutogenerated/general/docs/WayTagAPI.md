...
> MwGeneralBffInternalSchemasWayTagResponse CreateWayTag(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateWayTagPayload("Name_example", "WayUuid_example") // MwGeneralBffInternalSchemasCreateWayTagPayload | query params
	...
	// response from `CreateWayTag`: MwGeneralBffInternalSchemasWayTagResponse
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateWayTagPayload**](MwGeneralBffInternalSchemasCreateWayTagPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasWayTagResponse**](MwGeneralBffInternalSchemasWayTagResponse.md)
