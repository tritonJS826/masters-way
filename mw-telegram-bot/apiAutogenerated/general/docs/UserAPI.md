...
> MwGeneralBffInternalSchemasGetAllUsersResponse GetAllUsers(ctx).Page(page).Limit(limit).Email(email).Name(name).MentorStatus(mentorStatus).Execute()
...
func main() {
	...
	// response from `GetAllUsers`: MwGeneralBffInternalSchemasGetAllUsersResponse
...
[**MwGeneralBffInternalSchemasGetAllUsersResponse**](MwGeneralBffInternalSchemasGetAllUsersResponse.md)
...
> MwGeneralBffInternalSchemasUserPopulatedResponse GetUserByUuid(ctx, userId).Execute()
...
func main() {
	...
	// response from `GetUserByUuid`: MwGeneralBffInternalSchemasUserPopulatedResponse
...
> MwGeneralBffInternalSchemasUserPlainResponse UpdateUser(ctx, userId).Request(request).Execute()
...
func main() {
	userId := "userId_example" // string | user ID
	request := *openapiclient.NewMwGeneralBffInternalSchemasUpdateUserPayload() // MwGeneralBffInternalSchemasUpdateUserPayload | query params
	...
	// response from `UpdateUser`: MwGeneralBffInternalSchemasUserPlainResponse
 ...
 **request** | [**MwGeneralBffInternalSchemasUpdateUserPayload**](MwGeneralBffInternalSchemasUpdateUserPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasUserPlainResponse**](MwGeneralBffInternalSchemasUserPlainResponse.md)
