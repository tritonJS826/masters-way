...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateJobDoneJobTagPayload("JobDoneUuid_example", "JobTagUuid_example") // MwGeneralBffInternalSchemasCreateJobDoneJobTagPayload | query params
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateJobDoneJobTagPayload**](MwGeneralBffInternalSchemasCreateJobDoneJobTagPayload.md) | query params | 
