...
> MwGeneralBffInternalSchemasUserTagResponse CreateUserTag(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateUserTag`: MwGeneralBffInternalSchemasUserTagResponse
...
[**MwGeneralBffInternalSchemasUserTagResponse**](MwGeneralBffInternalSchemasUserTagResponse.md)
