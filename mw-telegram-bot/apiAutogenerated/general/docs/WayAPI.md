...
[**CreateWayFromTraining**](WayAPI.md#CreateWayFromTraining) | **Post** /ways/createFromTraining | Create a new way based on training
...
> MwGeneralBffInternalSchemasWayPlainResponse CreateWay(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateWay`: MwGeneralBffInternalSchemasWayPlainResponse
...
[**MwGeneralBffInternalSchemasWayPlainResponse**](MwGeneralBffInternalSchemasWayPlainResponse.md)
...
## CreateWayFromTraining

> MwGeneralBffInternalSchemasCreateWayFromTrainingResponse CreateWayFromTraining(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateWayFromTrainingPayload("TrainingId_example") // MwGeneralBffInternalSchemasCreateWayFromTrainingPayload | query params

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WayAPI.CreateWayFromTraining(context.Background()).Request(request).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WayAPI.CreateWayFromTraining``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateWayFromTraining`: MwGeneralBffInternalSchemasCreateWayFromTrainingResponse
	fmt.Fprintf(os.Stdout, "Response from `WayAPI.CreateWayFromTraining`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateWayFromTrainingRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateWayFromTrainingPayload**](MwGeneralBffInternalSchemasCreateWayFromTrainingPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasCreateWayFromTrainingResponse**](MwGeneralBffInternalSchemasCreateWayFromTrainingResponse.md)
...
> MwGeneralBffInternalSchemasGetAllWaysResponse GetAllWays(ctx).Page(page).Limit(limit).MinDayReportsAmount(minDayReportsAmount).WayName(wayName).Status(status).Execute()
...
func main() {
	...
	// response from `GetAllWays`: MwGeneralBffInternalSchemasGetAllWaysResponse
...
[**MwGeneralBffInternalSchemasGetAllWaysResponse**](MwGeneralBffInternalSchemasGetAllWaysResponse.md)
...
> []MwGeneralBffInternalSchemasUserOwnWay GetUserOwnWays(ctx, userId).Execute()
...
func main() {
	...
	// response from `GetUserOwnWays`: []MwGeneralBffInternalSchemasUserOwnWay
...
[**[]MwGeneralBffInternalSchemasUserOwnWay**](MwGeneralBffInternalSchemasUserOwnWay.md)
...
> MwGeneralBffInternalSchemasWayPopulatedResponse GetWayByUuid(ctx, wayId).Execute()
...
func main() {
	...
	// response from `GetWayByUuid`: MwGeneralBffInternalSchemasWayPopulatedResponse
...
[**MwGeneralBffInternalSchemasWayPopulatedResponse**](MwGeneralBffInternalSchemasWayPopulatedResponse.md)
...
> MwGeneralBffInternalSchemasWayStatisticsTriplePeriod GetWayStatisticsByUuid(ctx, wayId).Execute()
...
func main() {
	...
	// response from `GetWayStatisticsByUuid`: MwGeneralBffInternalSchemasWayStatisticsTriplePeriod
...
[**MwGeneralBffInternalSchemasWayStatisticsTriplePeriod**](MwGeneralBffInternalSchemasWayStatisticsTriplePeriod.md)
...
> MwGeneralBffInternalSchemasWayPlainResponse UpdateWay(ctx, wayId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateWay`: MwGeneralBffInternalSchemasWayPlainResponse
