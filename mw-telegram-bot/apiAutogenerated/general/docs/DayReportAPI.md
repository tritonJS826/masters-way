...
> MwGeneralBffInternalSchemasCompositeDayReportPopulatedResponse CreateDayReport(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateDayReportPayload("WayId_example") // MwGeneralBffInternalSchemasCreateDayReportPayload | query params
	...
	// response from `CreateDayReport`: MwGeneralBffInternalSchemasCompositeDayReportPopulatedResponse
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateDayReportPayload**](MwGeneralBffInternalSchemasCreateDayReportPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasCompositeDayReportPopulatedResponse**](MwGeneralBffInternalSchemasCompositeDayReportPopulatedResponse.md)
...
> MwGeneralBffInternalSchemasListDayReportsResponse GetDayReports(ctx, wayId).Page(page).Limit(limit).Execute()
...
func main() {
	...
	// response from `GetDayReports`: MwGeneralBffInternalSchemasListDayReportsResponse
...
[**MwGeneralBffInternalSchemasListDayReportsResponse**](MwGeneralBffInternalSchemasListDayReportsResponse.md)
