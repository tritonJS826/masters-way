...
func Test_openapi_NotificationAPIService(t *testing.T) {
	...
	t.Run("Test NotificationAPIService GetNotificationSettingList", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.NotificationAPI.GetNotificationSettingList(context.Background()).Execute()
	...
	t.Run("Test NotificationAPIService UpdateNotificationSetting", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var notificationSettingId string

		resp, httpRes, err := apiClient.NotificationAPI.UpdateNotificationSetting(context.Background(), notificationSettingId).Execute()
