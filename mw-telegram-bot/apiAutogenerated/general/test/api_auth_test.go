...
func Test_openapi_AuthAPIService(t *testing.T) {
	...
	t.Run("Test AuthAPIService TelegramInitiate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AuthAPI.TelegramInitiate(context.Background()).Execute()
	...
	t.Run("Test AuthAPIService TelegramValidate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AuthAPI.TelegramValidate(context.Background()).Execute()
