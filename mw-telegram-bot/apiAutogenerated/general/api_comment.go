...
// query params
func (r ApiCreateCommentTelegramRequest) Request(request MwGeneralBffInternalSchemasCreateCommentForTelegramPayload) ApiCreateCommentTelegramRequest {
	r.request = &request
	return r
}

func (r ApiCreateCommentTelegramRequest) Execute() (*MwGeneralBffInternalSchemasCommentPopulatedResponse, *http.Response, error) {
...
// Execute executes the request
//  @return MwGeneralBffInternalSchemasCommentPopulatedResponse
func (a *CommentAPIService) CreateCommentTelegramExecute(r ApiCreateCommentTelegramRequest) (*MwGeneralBffInternalSchemasCommentPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return MwGeneralBffInternalSchemasCommentPopulatedResponseStream
func (a *CommentAPIService) CreateCommentTelegramStreamExecute(r ApiCreateCommentTelegramRequest, request *http.Request, GoogleAccessToken string) (*MwGeneralBffInternalSchemasCommentPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwGeneralBffInternalSchemasCommentPopulatedResponse
	)
