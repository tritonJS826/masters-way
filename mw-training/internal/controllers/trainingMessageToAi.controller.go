...
func (tc *TrainingMessageToAiController) GetMessageToAI(ctx context.Context) (*pb.MessageToAI, error) {
...
func (tc *TrainingMessageToAiController) HandleResponseFromAiForItem(ctx context.Context, in *pb.MessageFromAI) error {
