...
type TrainingMentorRepository interface {
	CreateTrainingMentor(ctx context.Context, arg db.CreateTrainingMentorParams) (pb.TrainingMentor, error)
...
func (fts *TrainingMentorService) CreateTrainingMentor(ctx context.Context, arg db.CreateTrainingMentorParams) (pb.TrainingMentor, error) {
