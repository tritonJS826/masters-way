...
func (af *AuthFacade) RefreshAccessToken(ctx context.Context) (*openapiGeneral.MwServerInternalSchemasRefreshAccessTokenResponse, error) {
	return af.authService.RefreshAccessToken(ctx)
}
