...
func MakeTestWebsocketAPIClient(cfg *config.Config) *openapiTestWebsocket.APIClient {
	chatAPIConfig := &openapiTestWebsocket.Configuration{
		Host:   cfg.TestAPIWebsocketHost,
		Scheme: "http",
		Servers: openapiTestWebsocket.ServerConfigurations{
			{
				URL:         cfg.TestWebsocketBaseURL,
				Description: "mw-chat-websocket",
			},
		},
		HTTPClient: &http.Client{
	...
	return openapiTestWebsocket.NewAPIClient(chatAPIConfig)
}
