...
type GenerateTrainingDescriptionByTestResultsParams struct {
	TestName        string
	TestDescription string
	Language        string
	QuestionResults []*training.QuestionResult
	SessionResult   string
}

type GenerateTrainingDescriptionByTestResultsResponse struct {
	Name        string
	Description string
}

func (gs *GeneralService) GenerateTrainingDescriptionByTestResults(ctx context.Context, payload *GenerateTrainingDescriptionByTestResultsParams) (*GenerateTrainingDescriptionByTestResultsResponse, error) {
	testQuestionResults := lo.Map(payload.QuestionResults, func(questionResult *training.QuestionResult, _ int) openapiGeneral.MwServerInternalSchemasQuestionResult {
		return openapiGeneral.MwServerInternalSchemasQuestionResult{
	...
	trainingDescription, response, err := gs.generalAPI.GeminiAPI.AiDescriptionForTrainingByTestResults(ctx).Request(openapiGeneral.MwServerInternalSchemasAIGenerateTrainingDescriptionByTestResultsPayload{
		TestDescription:     payload.TestDescription,
		TestName:            payload.TestName,
		TestSessionResult:   payload.SessionResult,
		TestQuestionResults: testQuestionResults,
	}).Execute()
	...
	return &GenerateTrainingDescriptionByTestResultsResponse{
		Name:        trainingDescription.TrainingName,
		Description: trainingDescription.TrainingDescription,
	}, nil
...
func (gs *GeneralService) GenerateTopicsForTraining(ctx context.Context, payload *GenerateTopicsForTrainingParams) (*openapiGeneral.MwServerInternalSchemasAIGenerateTopicsForTrainingResponse, error) {
	estimateRaw, response, err := gs.generalAPI.GeminiAPI.AiTopicForTraining(ctx).Request(openapiGeneral.MwServerInternalSchemasAIGenerateTopicsForTrainingPayload{
		...
		Language:                   payload.Language,
		FullParentTopicDescription: payload.FullParentTopicDescription,
	}).Execute()
