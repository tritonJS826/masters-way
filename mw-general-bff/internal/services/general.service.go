...
func (gs *GeneralService) CreateJobDone(ctx context.Context, payload *schemas.CreateJobDonePayload) (*JobDone, error) {
	jobDoneRaw, response, err := gs.generalAPI.JobDoneAPI.CreateJobDone(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateJobDonePayload{
		DayReportUuid: payload.DayReportUuid,
		Description:   payload.Description,
...
func (gs *GeneralService) UpdateJobDone(ctx context.Context, params *UpdateJobDoneParams) (*JobDone, error) {
	jobDoneRaw, response, err := gs.generalAPI.JobDoneAPI.UpdateJobDone(ctx, params.JobDoneID).Request(openapiGeneral.MwserverInternalSchemasUpdateJobDone{
		Description: params.Description,
		Time:        params.Time,
	}).Execute()
...
func (gs *GeneralService) CreateMetric(ctx context.Context, payload *schemas.CreateMetricPayload) (*MetricResult, error) {
	metricRaw, response, err := gs.generalAPI.MetricAPI.CreateMetric(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateMetricPayload{
		Description:    payload.Description,
...
func (gs *GeneralService) UpdateMetric(ctx context.Context, params *UpdateMetricParams) (*MetricResult, error) {
	metricRaw, response, err := gs.generalAPI.MetricAPI.UpdateMetric(ctx, params.MetricID).Request(openapiGeneral.MwserverInternalSchemasUpdateMetricPayload{
		Description:    params.Description,
...
func (gs *GeneralService) CreatePlan(ctx context.Context, payload *schemas.CreatePlanPayload) (*Plan, error) {
	planRaw, response, err := gs.generalAPI.PlanAPI.CreatePlan(ctx).Request(openapiGeneral.MwserverInternalSchemasCreatePlanPayload{
		DayReportUuid: payload.DayReportUuid,
		Description:   payload.Description,
		IsDone:        payload.IsDone,
		OwnerUuid:     payload.OwnerUuid,
...
func (gs *GeneralService) UpdatePlan(ctx context.Context, params *UpdatePlanParams) (*Plan, error) {
	planRaw, response, err := gs.generalAPI.PlanAPI.UpdatePlan(ctx, params.PlanID).Request(openapiGeneral.MwserverInternalSchemasUpdatePlanPayload{
		Description: params.Description,
		IsDone:      params.IsDone,
		Time:        params.Time,
	}).Execute()
...
func (gs *GeneralService) CreateProblem(ctx context.Context, payload *schemas.CreateProblemPayload) (*schemas.ProblemPopulatedResponse, error) {
	problemRaw, response, err := gs.generalAPI.ProblemAPI.CreateProblem(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateProblemPayload{
		DayReportUuid: payload.DayReportUuid,
		Description:   payload.Description,
		IsDone:        payload.IsDone,
		OwnerUuid:     payload.OwnerUuid,
...
func (gs *GeneralService) UpdateProblem(ctx context.Context, params *UpdateProblemParams) (*schemas.ProblemPopulatedResponse, error) {
	problemRaw, response, err := gs.generalAPI.ProblemAPI.UpdateProblem(ctx, params.ProblemID).Request(openapiGeneral.MwserverInternalSchemasUpdateProblemPayload{
		Description: params.Description,
		IsDone:      params.IsDone,
	}).Execute()
...
func (gs *GeneralService) CreateProject(ctx context.Context, payload *schemas.CreateProjectPayload) (*ProjectResponse, error) {
	projectRaw, response, err := gs.generalAPI.ProjectAPI.CreateProject(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateProjectPayload{
		Name:    payload.Name,
...
func (gs *GeneralService) UpdateProject(ctx context.Context, params *UpdateProjectParams) (*ProjectResponse, error) {
	projectRaw, response, err := gs.generalAPI.ProjectAPI.UpdateProject(ctx, params.ID).Request(openapiGeneral.MwserverInternalSchemasUpdateProjectPayload{
...
func (gs *GeneralService) CreateToUserMentoringRequest(ctx context.Context, payload *schemas.CreateToUserMentoringRequestPayload) (*schemas.ToUserMentoringRequestResponse, error) {
	userMentorRaw, response, err := gs.generalAPI.ToUserMentoringRequestAPI.CreateUserMentoringRequest(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateToUserMentoringRequestPayload{
...
func (gs *GeneralService) UpdateUser(ctx context.Context, params *UpdateUserParams) (*schemas.UserPlainResponse, error) {
	userRaw, response, err := gs.generalAPI.UserAPI.UpdateUser(ctx, params.UserID).Request(openapiGeneral.MwserverInternalSchemasUpdateUserPayload{
		Description: params.Description,
...
func (gs *GeneralService) GetPopulatedUserById(ctx context.Context, userUuid uuid.UUID) (*schemas.UserPopulatedResponse, error) {
	...
	wayCollections := lo.Map(userRaw.CustomWayCollections, func(collection openapiGeneral.MwserverInternalSchemasWayCollectionPopulatedResponse, _ int) schemas.WayCollectionPopulatedResponse {
...
func (gs *GeneralService) AddUserTagByName(ctx context.Context, payload *schemas.CreateUserTagPayload) (*schemas.UserTagResponse, error) {
	userTagRaw, response, err := gs.generalAPI.UserTagAPI.CreateUserTag(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateUserTagPayload{
		Name:      payload.Name,
		OwnerUuid: payload.OwnerUuid,
	}).Execute()
...
func (gs *GeneralService) UpdateWayIsCompletedStatus(ctx context.Context, wayID string) error {
	IsCompleted := true
	_, response, err := gs.generalAPI.WayAPI.UpdateWay(ctx, wayID).Request(openapiGeneral.MwserverInternalSchemasUpdateWayPayload{
...
func (gs *GeneralService) CreateWay(ctx context.Context, payload *schemas.CreateWayPayload) (*schemas.WayPlainResponse, error) {
	...
	wayRaw, response, err := gs.generalAPI.WayAPI.CreateWay(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateWayPayload{
...
func (gs *GeneralService) UpdateWay(ctx context.Context, params *UpdateWayParams) (*schemas.WayPlainResponse, error) {
	wayRaw, response, err := gs.generalAPI.WayAPI.UpdateWay(ctx, params.WayID).Request(openapiGeneral.MwserverInternalSchemasUpdateWayPayload{
...
func (gs *GeneralService) CreateWayCollection(ctx context.Context, payload *schemas.CreateWayCollectionPayload) (*schemas.WayCollectionPopulatedResponse, error) {
	wayCollectionRaw, response, err := gs.generalAPI.WayCollectionAPI.CreateWayCollection(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateWayCollectionPayload{
		Name:      payload.Name,
		OwnerUuid: payload.OwnerUuid,
	}).Execute()
	...
	ways := lo.Map(wayCollectionRaw.Ways, func(way openapiGeneral.MwserverInternalSchemasWayPlainResponse, _ int) schemas.WayPlainResponse {
...
func (gs *GeneralService) UpdateWayCollection(ctx context.Context, wayCollectionID, wayCollectionName string) (*schemas.WayCollectionPlainResponse, error) {
	wayCollectionRaw, response, err := gs.generalAPI.WayCollectionAPI.UpdateWayCollection(ctx, wayCollectionID).Request(openapiGeneral.MwserverInternalSchemasUpdateWayCollectionPayload{
...
func (gs *GeneralService) CreateWayCollectionWay(ctx context.Context, payload *schemas.CreateWayCollectionWay) (*schemas.WayCollectionWayResponse, error) {
	wayCollectionRaw, response, err := gs.generalAPI.WayCollectionWayAPI.CreateWayCollectionWay(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateWayCollectionWay{
...
func (gs *GeneralService) AddWayTagToWay(ctx context.Context, name string, wayID string) (*schemas.WayTagResponse, error) {
	wayTagRaw, response, err := gs.generalAPI.WayTagAPI.CreateWayTag(ctx).Request(openapiGeneral.MwserverInternalSchemasCreateWayTagPayload{
		WayUuid: wayID,
		Name:    name,
	}).Execute()
