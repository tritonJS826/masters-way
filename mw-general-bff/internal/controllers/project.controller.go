...
func (pc *ProjectController) CreateProject(ctx *gin.Context) {
	...
	response, err := pc.generalService.CreateProject(ctx, payload)
...
func (pc *ProjectController) UpdateProject(ctx *gin.Context) {
	...
	response, err := pc.generalService.UpdateProject(ctx, &services.UpdateProjectParams{
		ID:        projectID,
		Name:      payload.Name,
...
func (pc *ProjectController) GetProjectByID(ctx *gin.Context) {
	...
	response, err := pc.generalService.GetProjectByID(ctx, projectID)
	utils.HandleErrorGin(ctx, err)
