...
func main() {
	message := *openapiclient.NewMwmailInternalSchemasMailRequest("Test Subject", []string{"To_example"}, "This is a test message.") // MwmailInternalSchemasMailRequest | Message content to be sent. Can be plain text or HTML-formatted text
...
------------- | ------------- | ------------- | -------------
 **message** | [**MwmailInternalSchemasMailRequest**](MwmailInternalSchemasMailRequest.md) | Message content to be sent. Can be plain text or HTML-formatted text | 
