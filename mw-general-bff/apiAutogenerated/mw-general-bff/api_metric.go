...
// query params
func (r ApiCreateMetricRequest) Request(request MwGeneralBffInternalSchemasCreateMetricPayload) ApiCreateMetricRequest {
	r.request = &request
	return r
}

func (r ApiCreateMetricRequest) Execute() (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
...
//  @return MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse
func (a *MetricAPIService) CreateMetricExecute(r ApiCreateMetricRequest) (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse
	)
...
// Execute executes the request
//  @return MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponseStream
func (a *MetricAPIService) CreateMetricStreamExecute(r ApiCreateMetricRequest, request *http.Request, GoogleAccessToken string) (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse
	)
...
// query params
func (r ApiUpdateMetricRequest) Request(request MwGeneralBffInternalSchemasUpdateMetricPayload) ApiUpdateMetricRequest {
	r.request = &request
	return r
}

func (r ApiUpdateMetricRequest) Execute() (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
...
// Execute executes the request
//  @return MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse
func (a *MetricAPIService) UpdateMetricExecute(r ApiUpdateMetricRequest) (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
	var (
...
// Execute executes the request
//  @return MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponseStream
func (a *MetricAPIService) UpdateMetricStreamExecute(r ApiUpdateMetricRequest, request *http.Request, GoogleAccessToken string) (*MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarReturnValue  *MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasMetricResponse
	)
