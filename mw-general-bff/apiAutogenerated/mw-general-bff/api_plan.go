...
// query params
func (r ApiCreatePlanRequest) Request(request SchemasCreatePlanPayload) ApiCreatePlanRequest {
	r.request = &request
	return r
}

func (r ApiCreatePlanRequest) Execute() (*SchemasPlanPopulatedResponse, *http.Response, error) {
...
//  @return SchemasPlanPopulatedResponse
func (a *PlanAPIService) CreatePlanExecute(r ApiCreatePlanRequest) (*SchemasPlanPopulatedResponse, *http.Response, error) {
	var (
...
// query params
func (r ApiUpdatePlanRequest) Request(request SchemasUpdatePlanPayload) ApiUpdatePlanRequest {
	r.request = &request
	return r
}

func (r ApiUpdatePlanRequest) Execute() (*SchemasPlanPopulatedResponse, *http.Response, error) {
...
// Execute executes the request
//  @return SchemasPlanPopulatedResponse
func (a *PlanAPIService) UpdatePlanExecute(r ApiUpdatePlanRequest) (*SchemasPlanPopulatedResponse, *http.Response, error) {
	var (
