...
type ApiCreateJobDone_0Request struct {
	ctx context.Context
	ApiService *JobDoneAPIService
	request *SchemasCreateJobDonePayload
}
...
// query params
func (r ApiCreateJobDone_0Request) Request(request SchemasCreateJobDonePayload) ApiCreateJobDone_0Request {
	r.request = &request
	return r
}

func (r ApiCreateJobDone_0Request) Execute() (*SchemasJobDonePopulatedResponse, *http.Response, error) {
	return r.ApiService.CreateJobDone_1Execute(r)
}

/*
CreateJobDone_0 Create a new jobDone

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateJobDone_0Request
*/
func (a *JobDoneAPIService) CreateJobDone_1(ctx context.Context) ApiCreateJobDone_0Request {
	return ApiCreateJobDone_0Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SchemasJobDonePopulatedResponse
func (a *JobDoneAPIService) CreateJobDone_1Execute(r ApiCreateJobDone_0Request) (*SchemasJobDonePopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "JobDoneAPIService.CreateJobDone_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
//  @return SchemasJobDonePopulatedResponseStream
func (a *JobDoneAPIService) CreateJobDone_1StreamExecute(r ApiCreateJobDone_0Request, request *http.Request, GoogleAccessToken string) (*SchemasJobDonePopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *SchemasJobDonePopulatedResponse
	)
