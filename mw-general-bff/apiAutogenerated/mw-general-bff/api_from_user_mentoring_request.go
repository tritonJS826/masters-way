...
// query params
func (r ApiCreateFromUserMentoringRequestRequest) Request(request MwGeneralBffInternalSchemasCreateFromUserMentoringRequestPayload) ApiCreateFromUserMentoringRequestRequest {
	r.request = &request
	return r
}

func (r ApiCreateFromUserMentoringRequestRequest) Execute() (*MwGeneralBffInternalSchemasFromUserMentoringRequestResponse, *http.Response, error) {
...
//  @return MwGeneralBffInternalSchemasFromUserMentoringRequestResponse
func (a *FromUserMentoringRequestAPIService) CreateFromUserMentoringRequestExecute(r ApiCreateFromUserMentoringRequestRequest) (*MwGeneralBffInternalSchemasFromUserMentoringRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MwGeneralBffInternalSchemasFromUserMentoringRequestResponse
	)
...
// Execute executes the request
//  @return MwGeneralBffInternalSchemasFromUserMentoringRequestResponseStream
func (a *FromUserMentoringRequestAPIService) CreateFromUserMentoringRequestStreamExecute(r ApiCreateFromUserMentoringRequestRequest, request *http.Request, GoogleAccessToken string) (*MwGeneralBffInternalSchemasFromUserMentoringRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwGeneralBffInternalSchemasFromUserMentoringRequestResponse
	)
