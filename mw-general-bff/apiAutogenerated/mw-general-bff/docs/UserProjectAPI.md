...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateUserProjectPayload("ProjectId_example", "UserId_example") // MwGeneralBffInternalSchemasCreateUserProjectPayload | query params
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateUserProjectPayload**](MwGeneralBffInternalSchemasCreateUserProjectPayload.md) | query params | 
