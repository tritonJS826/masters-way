...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse GetCurrentAuthorizedUser(ctx).Execute()
...
func main() {
	...
	// response from `GetCurrentAuthorizedUser`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGoogleToken GetGoogleToken(ctx).Execute()
...
func main() {
	...
	// response from `GetGoogleToken`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGoogleToken
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGoogleToken**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGoogleToken.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasRefreshAccessTokenResponse RefreshAccessToken(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasRefreshAccessTokenPayload("RefreshToken_example") // MwGeneralBffInternalSchemasRefreshAccessTokenPayload | query params
	...
	// response from `RefreshAccessToken`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasRefreshAccessTokenResponse
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasRefreshAccessTokenPayload**](MwGeneralBffInternalSchemasRefreshAccessTokenPayload.md) | query params | 

### Return type

[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasRefreshAccessTokenResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasRefreshAccessTokenResponse.md)
