...
> MwGeneralBffInternalSchemasRefreshAccessTokenResponse RefreshAccessToken(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `RefreshAccessToken`: MwGeneralBffInternalSchemasRefreshAccessTokenResponse
