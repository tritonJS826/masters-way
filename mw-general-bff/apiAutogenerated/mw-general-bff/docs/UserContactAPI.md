...
> MwGeneralBffInternalSchemasUserContact UpdateUserContact(ctx, userId, contactId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateUserContact`: MwGeneralBffInternalSchemasUserContact
