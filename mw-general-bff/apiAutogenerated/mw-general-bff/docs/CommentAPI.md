...
> MwGeneralBffInternalSchemasCommentPopulatedResponse CreateCommentTelegram(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateCommentForTelegramPayload("Description_example", "OwnerUuid_example", "WayUuid_example") // MwGeneralBffInternalSchemasCreateCommentForTelegramPayload | query params
	...
	// response from `CreateCommentTelegram`: MwGeneralBffInternalSchemasCommentPopulatedResponse
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateCommentForTelegramPayload**](MwGeneralBffInternalSchemasCreateCommentForTelegramPayload.md) | query params | 
