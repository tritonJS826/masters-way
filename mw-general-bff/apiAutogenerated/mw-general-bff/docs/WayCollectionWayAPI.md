...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse CreateWayCollectionWay(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateWayCollectionWay("WayCollectionUuid_example", "WayUuid_example") // MwGeneralBffInternalSchemasCreateWayCollectionWay | query params
	...
	// response from `CreateWayCollectionWay`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateWayCollectionWay**](MwGeneralBffInternalSchemasCreateWayCollectionWay.md) | query params | 

### Return type

[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayCollectionWayResponse.md)
