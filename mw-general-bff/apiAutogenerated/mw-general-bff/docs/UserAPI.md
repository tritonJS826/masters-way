...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGetAllUsersResponse GetAllUsers(ctx).Page(page).Limit(limit).Email(email).Name(name).MentorStatus(mentorStatus).Execute()
...
func main() {
	...
	// response from `GetAllUsers`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGetAllUsersResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGetAllUsersResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasGetAllUsersResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse GetUserByUuid(ctx, userId).Execute()
...
func main() {
	...
	// response from `GetUserByUuid`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPopulatedResponse
...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPlainResponse UpdateUser(ctx, userId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateUser`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPlainResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPlainResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasUserPlainResponse.md)
