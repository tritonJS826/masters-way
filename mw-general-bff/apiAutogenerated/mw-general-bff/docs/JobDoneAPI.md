...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse CreateJobDone(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateJobDone`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse UpdateJobDone(ctx, jobDoneId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateJobDone`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasJobDonePopulatedResponse
