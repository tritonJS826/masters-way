...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasCompositeDayReportPopulatedResponse CreateDayReport(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateDayReport`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasCompositeDayReportPopulatedResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasCompositeDayReportPopulatedResponse**](MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasCompositeDayReportPopulatedResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasListDayReportsResponse GetDayReports(ctx, wayId).Page(page).Limit(limit).Execute()
...
func main() {
	...
	// response from `GetDayReports`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasListDayReportsResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasListDayReportsResponse**](MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasListDayReportsResponse.md)
