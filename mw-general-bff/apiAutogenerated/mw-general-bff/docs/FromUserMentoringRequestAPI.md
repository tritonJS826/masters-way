...
> MwGeneralBffInternalSchemasFromUserMentoringRequestResponse CreateFromUserMentoringRequest(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateFromUserMentoringRequestPayload("UserUuid_example", "WayUuid_example") // MwGeneralBffInternalSchemasCreateFromUserMentoringRequestPayload | query params
	...
	// response from `CreateFromUserMentoringRequest`: MwGeneralBffInternalSchemasFromUserMentoringRequestResponse
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateFromUserMentoringRequestPayload**](MwGeneralBffInternalSchemasCreateFromUserMentoringRequestPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasFromUserMentoringRequestResponse**](MwGeneralBffInternalSchemasFromUserMentoringRequestResponse.md)
