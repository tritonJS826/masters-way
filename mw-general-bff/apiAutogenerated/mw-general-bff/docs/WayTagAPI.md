...
> MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayTagResponse CreateWayTag(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateWayTag`: MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayTagResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayTagResponse**](MwGeneralBffApiAutogeneratedGeneralMwServerInternalSchemasWayTagResponse.md)
