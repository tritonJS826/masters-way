...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPopulatedResponse CreateWayCollection(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateWayCollection`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPopulatedResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPopulatedResponse**](MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPopulatedResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPlainResponse UpdateWayCollection(ctx, wayCollectionId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateWayCollection`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPlainResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPlainResponse**](MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasWayCollectionPlainResponse.md)
