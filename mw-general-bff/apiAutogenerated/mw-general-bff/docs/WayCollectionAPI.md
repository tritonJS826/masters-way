...
> MwGeneralBffInternalSchemasWayCollectionPopulatedResponse CreateWayCollection(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateWayCollectionPayload("Name_example", "OwnerUuid_example") // MwGeneralBffInternalSchemasCreateWayCollectionPayload | query params
	...
	// response from `CreateWayCollection`: MwGeneralBffInternalSchemasWayCollectionPopulatedResponse
...
------------- | ------------- | ------------- | -------------
 **request** | [**MwGeneralBffInternalSchemasCreateWayCollectionPayload**](MwGeneralBffInternalSchemasCreateWayCollectionPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasWayCollectionPopulatedResponse**](MwGeneralBffInternalSchemasWayCollectionPopulatedResponse.md)
...
> MwGeneralBffInternalSchemasWayCollectionPlainResponse UpdateWayCollection(ctx, wayCollectionId).Request(request).Execute()
...
func main() {
	wayCollectionId := "wayCollectionId_example" // string | wayCollection ID
	request := *openapiclient.NewMwGeneralBffInternalSchemasUpdateWayCollectionPayload() // MwGeneralBffInternalSchemasUpdateWayCollectionPayload | query params
	...
	// response from `UpdateWayCollection`: MwGeneralBffInternalSchemasWayCollectionPlainResponse
 ...
 **request** | [**MwGeneralBffInternalSchemasUpdateWayCollectionPayload**](MwGeneralBffInternalSchemasUpdateWayCollectionPayload.md) | query params | 

### Return type

[**MwGeneralBffInternalSchemasWayCollectionPlainResponse**](MwGeneralBffInternalSchemasWayCollectionPlainResponse.md)
