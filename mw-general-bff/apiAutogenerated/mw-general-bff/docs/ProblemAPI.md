...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse CreateProblem(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `CreateProblem`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse
...
[**MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse**](MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse.md)
...
> MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse UpdateProblem(ctx, problemId).Request(request).Execute()
...
func main() {
	...
	// response from `UpdateProblem`: MwGeneralBffApiAutogeneratedGeneralMwserverInternalSchemasProblemPopulatedResponse
