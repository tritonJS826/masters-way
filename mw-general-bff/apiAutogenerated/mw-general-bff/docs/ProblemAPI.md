...
> MwGeneralBffInternalSchemasProblemPopulatedResponse CreateProblem(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewMwGeneralBffInternalSchemasCreateProblemPayload("DayReportUuid_example", "Description_example", false, "OwnerUuid_example") // MwGeneralBffInternalSchemasCreateProblemPayload | query params
	...
	// response from `CreateProblem`: MwGeneralBffInternalSchemasProblemPopulatedResponse
...
> MwGeneralBffInternalSchemasProblemPopulatedResponse UpdateProblem(ctx, problemId).Request(request).Execute()
...
func main() {
	problemId := "problemId_example" // string | problem ID
	request := *openapiclient.NewMwGeneralBffInternalSchemasUpdateProblemPayload() // MwGeneralBffInternalSchemasUpdateProblemPayload | query params
	...
	// response from `UpdateProblem`: MwGeneralBffInternalSchemasProblemPopulatedResponse
 ...
 **request** | [**MwGeneralBffInternalSchemasUpdateProblemPayload**](MwGeneralBffInternalSchemasUpdateProblemPayload.md) | query params | 
