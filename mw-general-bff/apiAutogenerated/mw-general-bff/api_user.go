...
// query params
func (r ApiGetUsersByIdsRequest) Request(request []string) ApiGetUsersByIdsRequest {
	r.request = &request
	return r
}
...
*/
func (a *UserAPIService) GetUsersByIds(ctx context.Context) ApiGetUsersByIdsRequest {
	return ApiGetUsersByIdsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserAPIService) GetUsersByIdsExecute(r ApiGetUsersByIdsRequest) ([]SchemasGetUsersByIDsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/users/list-by-ids"
