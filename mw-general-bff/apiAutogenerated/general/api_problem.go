...
type ApiCreateProblemTelegramRequest struct {
	ctx context.Context
	ApiService *ProblemAPIService
	request *MwServerInternalSchemasCreateProblemForTelegramPayload
}

// query params
func (r ApiCreateProblemTelegramRequest) Request(request MwServerInternalSchemasCreateProblemForTelegramPayload) ApiCreateProblemTelegramRequest {
	r.request = &request
	return r
}

func (r ApiCreateProblemTelegramRequest) Execute() (*MwServerInternalSchemasProblemPopulatedResponse, *http.Response, error) {
...
// Execute executes the request
//  @return MwServerInternalSchemasProblemPopulatedResponse
func (a *ProblemAPIService) CreateProblemTelegramExecute(r ApiCreateProblemTelegramRequest) (*MwServerInternalSchemasProblemPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return MwServerInternalSchemasProblemPopulatedResponseStream
func (a *ProblemAPIService) CreateProblemTelegramStreamExecute(r ApiCreateProblemTelegramRequest, request *http.Request, GoogleAccessToken string) (*MwServerInternalSchemasProblemPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwServerInternalSchemasProblemPopulatedResponse
	)
