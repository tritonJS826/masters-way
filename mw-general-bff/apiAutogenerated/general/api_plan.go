...
type ApiCreatePlanTelegramRequest struct {
	ctx context.Context
	ApiService *PlanAPIService
	request *MwServerInternalSchemasCreatePlanForTelegramPayload
}

// query params
func (r ApiCreatePlanTelegramRequest) Request(request MwServerInternalSchemasCreatePlanForTelegramPayload) ApiCreatePlanTelegramRequest {
	r.request = &request
	return r
}

func (r ApiCreatePlanTelegramRequest) Execute() (*MwServerInternalSchemasPlanPopulatedResponse, *http.Response, error) {
...
// Execute executes the request
//  @return MwServerInternalSchemasPlanPopulatedResponse
func (a *PlanAPIService) CreatePlanTelegramExecute(r ApiCreatePlanTelegramRequest) (*MwServerInternalSchemasPlanPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return MwServerInternalSchemasPlanPopulatedResponseStream
func (a *PlanAPIService) CreatePlanTelegramStreamExecute(r ApiCreatePlanTelegramRequest, request *http.Request, GoogleAccessToken string) (*MwServerInternalSchemasPlanPopulatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwServerInternalSchemasPlanPopulatedResponse
	)
