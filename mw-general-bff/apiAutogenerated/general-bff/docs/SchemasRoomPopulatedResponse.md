...
`func NewSchemasRoomPopulatedResponse(imageUrl string, isBlocked bool, messages []SchemasMessageResponse, name string, roomId string, roomType string, users []SchemasUserResponse, ) *SchemasRoomPopulatedResponse`
