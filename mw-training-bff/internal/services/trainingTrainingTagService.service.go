...
type TrainingTrainingTagService struct {
	notificationGRPC        pb.TrainingTrainingTagServiceServiceClient
...
func NewTrainingTrainingTagService(
	...
	return &TrainingTrainingTagService{notificationGRPC, notificationSettingGRPC}
}
...
func (ns *TrainingTrainingTagService) GetNotificationList(ctx context.Context, params *GetNotificationListParams) (*schemas.GetNotificationListResponse, error) {
...
func (ns *TrainingTrainingTagService) UpdateNotification(ctx context.Context, notificationUUID string, isRead bool) (*schemas.NotificationResponse, error) {
...
func (ns *TrainingTrainingTagService) GetNotificationSettingList(ctx context.Context, userUUID string) (*schemas.GetNotificationSettingListResponse, error) {
...
func (ns *TrainingTrainingTagService) UpdateNotificationSetting(ctx context.Context, notificationSettingID string, isEnabled bool) (*schemas.NotificationSettingResponse, error) {
