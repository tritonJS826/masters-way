...
func NewMessageController(generalService *services.GeneralService, chatService *services.ChatService) *MessageController {
	return &MessageController{generalService, chatService}
}
