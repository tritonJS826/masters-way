...
type ApiCreateMessageRequest struct {
	...
	request *MwTrainingInternalSchemasCreateMessagePayload
}

// query params
func (r ApiCreateMessageRequest) Request(request MwTrainingInternalSchemasCreateMessagePayload) ApiCreateMessageRequest {
	r.request = &request
	return r
}

func (r ApiCreateMessageRequest) Execute() (*MwTrainingInternalSchemasCreateMessageResponse, *http.Response, error) {
...
//  @return MwTrainingInternalSchemasCreateMessageResponse
func (a *MessageAPIService) CreateMessageExecute(r ApiCreateMessageRequest) (*MwTrainingInternalSchemasCreateMessageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MwTrainingInternalSchemasCreateMessageResponse
	)
...
// Execute executes the request
//  @return MwTrainingInternalSchemasCreateMessageResponseStream
func (a *MessageAPIService) CreateMessageStreamExecute(r ApiCreateMessageRequest, request *http.Request, GoogleAccessToken string) (*MwTrainingInternalSchemasCreateMessageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwTrainingInternalSchemasCreateMessageResponse
	)
...
type ApiUpdateMessageStatusRequest struct {
	...
	ApiService *MessageAPIService
	messageId string
	request *MwTrainingInternalSchemasUpdateMessageStatusPayload
}

// query params
func (r ApiUpdateMessageStatusRequest) Request(request MwTrainingInternalSchemasUpdateMessageStatusPayload) ApiUpdateMessageStatusRequest {
	r.request = &request
	return r
}
