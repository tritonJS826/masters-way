...
> MwChatBffInternalSchemasRoomPopulatedResponse FindOrCreateRoom(ctx).Request(request).Execute()
...
func main() {
	...
	// response from `FindOrCreateRoom`: MwChatBffInternalSchemasRoomPopulatedResponse
