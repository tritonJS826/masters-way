...
type ApiCreateMessageRequest struct {
	...
	request *MwTrainingBffInternalSchemasCreateMessagePayload
}

// query params
func (r ApiCreateMessageRequest) Request(request MwTrainingBffInternalSchemasCreateMessagePayload) ApiCreateMessageRequest {
	r.request = &request
	return r
}

func (r ApiCreateMessageRequest) Execute() (*MwTrainingBffInternalSchemasMessageResponse, *http.Response, error) {
...
//  @return MwTrainingBffInternalSchemasMessageResponse
func (a *MessageAPIService) CreateMessageExecute(r ApiCreateMessageRequest) (*MwTrainingBffInternalSchemasMessageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MwTrainingBffInternalSchemasMessageResponse
	)
...
// Execute executes the request
//  @return MwTrainingBffInternalSchemasMessageResponseStream
func (a *MessageAPIService) CreateMessageStreamExecute(r ApiCreateMessageRequest, request *http.Request, GoogleAccessToken string) (*MwTrainingBffInternalSchemasMessageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarReturnValue  *MwTrainingBffInternalSchemasMessageResponse
	)
...
type ApiUpdateMessageStatusRequest struct {
	...
	ApiService *MessageAPIService
	messageId string
	request *MwTrainingBffInternalSchemasUpdateMessageStatusPayload
}

// query params
func (r ApiUpdateMessageStatusRequest) Request(request MwTrainingBffInternalSchemasUpdateMessageStatusPayload) ApiUpdateMessageStatusRequest {
	r.request = &request
	return r
}
